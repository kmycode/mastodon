              ...
              <li>
                ...
                {isSelf ? (
                  ...
                  <FormattedMessage
                    ...
                    defaultMessage='{domain} is the server that hosts the user’s profile and posts. the server is using {software} software, but you can view posts and participate in conversations just like other users.'
                    values={{
