...
class StatusesSearchService < BaseService
  ...
  def status_search_results
    ...
    results             = elastic_stoplight_wrapper.run { request.timeout(ES_QUERY_TIMEOUT).collapse(field: :id).order(id: { order: query.order_by }).limit(@limit).offset(@offset).objects.compact }
