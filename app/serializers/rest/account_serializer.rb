...
class REST::AccountSerializer < ActiveModel::Serializer
  ...
  attributes :id, :username, :acct, :display_name, :locked, :bot, :discoverable, :indexable, :group, :created_at,
             :note, :url, :uri, :avatar, :avatar_static, :avatar_description, :header, :header_static, :header_description, :subscribable,
             :followers_count, :following_count, :statuses_count, :last_status_at, :hide_collections, :other_settings, :noindex,
             :show_media, :show_media_replies, :show_featured, :server_features, :software
