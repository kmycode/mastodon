  ...
  describe '#to_s' do
    ...
    context 'when given text with an emoji shortcode at the start' do
      ...
      it 'converts the shortcode to an image tag' do
        expect(subject).to include('<img rel="emoji" draggable="false" height="16" class="emojione custom-emoji" style="min-width:16px;" alt=":coolcat:"')
      end
    end
    ...
    context 'when given text with an emoji shortcode in the middle' do
      ...
      it 'converts the shortcode to an image tag' do
        expect(subject).to include('Beep <img rel="emoji" draggable="false" height="16" class="emojione custom-emoji" style="min-width:16px;" alt=":coolcat:"')
      end
    end
    ...
    context 'when given text with an emoji shortcode at the end' do
      ...
      it 'converts the shortcode to an image tag' do
        expect(subject).to include('boop <img rel="emoji" draggable="false" height="16" class="emojione custom-emoji" style="min-width:16px;" alt=":coolcat:"')
      end
    end
  end
end
